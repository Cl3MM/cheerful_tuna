CheerfulTuna::Application.configure do
  ...
  config.logger = Logger.new( Rails.root.join("log", Rails.env + ".log"), 10, 2*1024*1024 )
  ...
  config.assets.precompile += %w( sessions.css mailings.css jquery.ui.theme.css mailings.js )
  config.assets.precompile += %w( jquery-timepicker-addon.js jquery-ui-slider-access.js )
