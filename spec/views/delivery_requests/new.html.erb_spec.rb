...
describe "delivery_requests/new" do
  before(:each) do
    assign(:delivery_request, stub_model(DeliveryRequest,
      :name => "MyString",
      :email => "MyString",
      :telephone => "MyString",
      :address => "MyString",
  ...
  it "renders new delivery_request form" do
    render

    # Run the generator again with the --webrat flag if you want to use webrat matchers
    assert_select "form", :action => delivery_requests_path, :method => "post" do
